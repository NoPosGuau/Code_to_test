...
# almacenar el link en una variable
...
class homePage():
    ...
    # funcion para cambiar a los frame que contiene la pagina e interactuar en ella.
    def switch_to_iframe(self):
        iframe = self.get_iframe_sign_up()
        self.driver.switch_to.frame(iframe)

    # funcion para retornar el URL de la pagina.
    @staticmethod
    def get_base_url():
        return base_url
